...
export default function TopMenu({ onClickContentType, onChangeMuted, contentType, muted }: { onClickContentType? : (type: string) => void, onChangeMuted? : (type: boolean) => void, contentType : string, muted : boolean }) {
                    ...
                    <div className="bruh">
                        {isAboutMe && 
                            <div className="bruh">
                                ...
                                <br/>
                                {contentType != 'education' && <a className="select trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onSelect('education')}>Education</a>}
                                {contentType == 'education' && <a className="select trump green-border white-text" onMouseEnter={() => onHover()} onClick={() => onSelect('education')}>Education</a>}
                            </div>
                        }
                        {!isAboutMe && 
                            <div className="bruh">
                                ...
                                <br/>
                                {contentType != 'athleda' && <a className="select trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onSelect('athleda')}>The athLEDA Foundation</a>}
                                {contentType == 'athleda' && <a className="select trump green-border white-text" onMouseEnter={() => onHover()} onClick={() => onSelect('athleda')}>The athLEDA Foundation</a>}
                            </div>
                        }
                    </div>
                </div>
