    ...
    return (
        <div className="right-column">
            ...
            <div className="select-rows">
                {isAboutMe && <div>
                    {contentType != 'summary' && <a className="trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('summary')}>Summary</a>}
                    {contentType == 'summary' && <a className="trump green-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('summary')}>Summary</a>}
                    <br/>
                    {contentType != 'education' && <a className="trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('education')}>Education</a>}
                    {contentType == 'education' && <a className="trump green-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('education')}>Education</a>}
                </div>}
                {!isAboutMe && <div>
                    {contentType != 'ace' && <a className="trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('ace')}>ACE Rent A Car</a>}
                    ...
                    <br/>
                    {contentType != 'athleda' && <a className="trump blue-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('athleda')}>The athLEDA Foundation</a>}
                    {contentType == 'athleda' && <a className="trump green-border white-text" onMouseEnter={() => onHover()} onClick={() => onClickContentType?.('athleda')}>The athLEDA Foundation</a>}
                </div>}
            </div>
        </div>
    )
